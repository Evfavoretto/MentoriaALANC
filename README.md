...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* 🔥 Remover header/título padrão do GitHub Pages (vários temas) */
    .page-header, .site-header, .site-title, .site-nav,
    ...
    /* Barra rosa colada no topo (70px) */
    .top-bar{
      background:var(--pink); color:#fff; text-align:center;
      padding:70px 10px; /* barra alta para “empurrar” o topo do tema */
